...
* imdbToken - Токен IMDB
  * Получить можно [здесь](https://www.omdbapi.com/apikey.aspx)
  ...
  # Возможности
  Поиск аниме, манги, фильмов и сериалов.

  ## Слеш-команды
  * mal-search - поиск аниме/манги на MAL
  * imdb-search - поиск фильмов/сериалов на IMDB
 
  ## Команды меню
  * MAL: Get anime/manga info - поиск аниме/манги на MAL
  * IMDB: Get film/series info - поиск фильмов/сериалов на IMDB
 
  Для успешного поиска, сообщение должно быть в формате
  ```
- \`Название\`:a \\ для аниме
- \`Название\`:m \\ для манги
- \`Название\` \\ для IMDB
  ```
